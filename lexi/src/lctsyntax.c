...
#line 241 "lctsyntax.c"
			}
			/* END OF EXTRACT: code-ident */
			ADVANCE_LEXER;
			/* BEGINNING OF ACTION: false */
			{
#line 136 "lctsyntax.act"
 (ZIb) = false; 
