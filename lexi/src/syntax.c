...
#line 820 "syntax.act"
	...
	xfree((ZIs));
	EntryT* entry;
	entry=table_get_entry((ZIz)->top_level->table, &str);
	if(entry != NULL) {
		nstring_destroy(&str);
		/* TODO switch ? */
