...
struct EntryT **tree_get_table(lexer_parse_tree *);
...
struct EntryT *lexer_char_type(struct lexer_parse_tree_tag *);
struct EntryT *lexer_string_type(struct lexer_parse_tree_tag *);
struct EntryT *lexer_int_type(struct lexer_parse_tree_tag *);
struct EntryT *lexer_terminal_type(struct lexer_parse_tree_tag *);
