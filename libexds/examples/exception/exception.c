 ...
 * without digressing into minutae.
 *
 * Exceptions may be nested to form stacks
 * (these examples don't nest deeply, for berevity). They may be thrown from
 * other functions (which is not illustrated, again for berevity).
 *
