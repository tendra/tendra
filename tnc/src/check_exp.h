...
#define sub0(X)	((X)->son)
#define sub1(X)	((X)->son->next)
#define sub2(X)	((X)->son->next->next)
#define sub3(X)	((X)->son->next->next->next)
#define sub4(X)	((X)->son->next->next->next->next)
#define sub5(X)	((X)->son->next->next->next->next->next)
#define sub6(X)	((X)->son->next->next->next->next->next->next)
#define sub7(X)	((X)->son->next->next->next->next->next->next->next)
