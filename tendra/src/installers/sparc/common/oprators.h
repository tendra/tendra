...
extern bool regremoved PROTO_S ( ( exp *, int ) ) ;
...
extern int absop PROTO_S ( ( exp, space, where ) ) ;
extern int non_comm_op PROTO_S ( ( exp, space, where, ins_p ) ) ;
extern void do_comm PROTO_S ( ( exp, space, int, ins_p ) ) ;
extern void tidyshort PROTO_S ( ( int, shape ) ) ;

extern void quad_op PROTO_S ( ( exp, exp, space, where, int ) ) ;
