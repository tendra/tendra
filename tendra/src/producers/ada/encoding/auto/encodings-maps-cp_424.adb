...
package body Encodings.Maps.CP_424 is
   ...
   Ranges   : Maps.Wide_Ranges  (1 ..  46) :=
     ((Wide_Character'Val(   16#0#),Wide_Character'Val(  16#A0#), 1),
      ...
      (Wide_Character'Val(16#2017#),Wide_Character'Val(16#2017#), 218),
...
begin
   Encoder_List (Encodings.CP_424) := Encode'Access;
   Decoder_List (Encodings.CP_424) := Decode'Access;
