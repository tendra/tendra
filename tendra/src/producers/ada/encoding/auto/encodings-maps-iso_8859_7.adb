...
package body Encodings.Maps.ISO_8859_7 is
   ...
   Ranges   : Maps.Wide_Ranges  (1 ..  18) :=
     ((Wide_Character'Val(   16#0#),Wide_Character'Val(  16#A0#), 1),
      (Wide_Character'Val(  16#A3#),Wide_Character'Val(  16#A3#), 162),
      (Wide_Character'Val(  16#A6#),Wide_Character'Val(  16#A9#), 163),
      (Wide_Character'Val(  16#AB#),Wide_Character'Val(  16#AD#), 167),
      (Wide_Character'Val(  16#B0#),Wide_Character'Val(  16#B3#), 170),
      (Wide_Character'Val(  16#B7#),Wide_Character'Val(  16#B7#), 174),
      (Wide_Character'Val(  16#BB#),Wide_Character'Val(  16#BB#), 175),
      (Wide_Character'Val(  16#BD#),Wide_Character'Val(  16#BD#), 176),
      (Wide_Character'Val( 16#37A#),Wide_Character'Val( 16#37A#), 177),
      (Wide_Character'Val( 16#384#),Wide_Character'Val( 16#386#), 178),
      (Wide_Character'Val( 16#388#),Wide_Character'Val( 16#38A#), 181),
      (Wide_Character'Val( 16#38C#),Wide_Character'Val( 16#38C#), 184),
      (Wide_Character'Val( 16#38E#),Wide_Character'Val( 16#3A1#), 185),
      (Wide_Character'Val( 16#3A3#),Wide_Character'Val( 16#3CE#), 205),
      (Wide_Character'Val(16#2015#),Wide_Character'Val(16#2015#), 249),
      (Wide_Character'Val(16#2018#),Wide_Character'Val(16#2019#), 250),
      (Wide_Character'Val(16#20AC#),Wide_Character'Val(16#20AC#), 252),
      (Wide_Character'Val(16#20AF#),Wide_Character'Val(16#20AF#), 253));

   Backward : Maps.Backward_Map (1 ..  253) :=
     (Character'Val( 16#0#),
      Character'Val( 16#1#),
      Character'Val( 16#2#),
      Character'Val( 16#3#),
...
begin
   Encoder_List (Encodings.ISO_8859_7) := Encode'Access;
   Decoder_List (Encodings.ISO_8859_7) := Decode'Access;
