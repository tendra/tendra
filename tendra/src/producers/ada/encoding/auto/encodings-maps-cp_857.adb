...
package body Encodings.Maps.CP_857 is
   ...
   Ranges   : Maps.Wide_Ranges  (1 ..  38) :=
     ((Wide_Character'Val(   16#0#),Wide_Character'Val(  16#7F#), 1),
      (Wide_Character'Val(  16#A0#),Wide_Character'Val(  16#CF#), 129),
      (Wide_Character'Val(  16#D1#),Wide_Character'Val(  16#DC#), 177),
      (Wide_Character'Val(  16#DF#),Wide_Character'Val(  16#EF#), 189),
      (Wide_Character'Val(  16#F1#),Wide_Character'Val(  16#FC#), 206),
      (Wide_Character'Val(  16#FF#),Wide_Character'Val(  16#FF#), 218),
      (Wide_Character'Val( 16#11E#),Wide_Character'Val( 16#11F#), 219),
      (Wide_Character'Val( 16#130#),Wide_Character'Val( 16#131#), 221),
      (Wide_Character'Val( 16#15E#),Wide_Character'Val( 16#15F#), 223),
      (Wide_Character'Val(16#2500#),Wide_Character'Val(16#2500#), 225),
      (Wide_Character'Val(16#2502#),Wide_Character'Val(16#2502#), 226),
      (Wide_Character'Val(16#250C#),Wide_Character'Val(16#250C#), 227),
      (Wide_Character'Val(16#2510#),Wide_Character'Val(16#2510#), 228),
      (Wide_Character'Val(16#2514#),Wide_Character'Val(16#2514#), 229),
      (Wide_Character'Val(16#2518#),Wide_Character'Val(16#2518#), 230),
      (Wide_Character'Val(16#251C#),Wide_Character'Val(16#251C#), 231),
      (Wide_Character'Val(16#2524#),Wide_Character'Val(16#2524#), 232),
      (Wide_Character'Val(16#252C#),Wide_Character'Val(16#252C#), 233),
      (Wide_Character'Val(16#2534#),Wide_Character'Val(16#2534#), 234),
      (Wide_Character'Val(16#253C#),Wide_Character'Val(16#253C#), 235),
      (Wide_Character'Val(16#2550#),Wide_Character'Val(16#2551#), 236),
      (Wide_Character'Val(16#2554#),Wide_Character'Val(16#2554#), 238),
      (Wide_Character'Val(16#2557#),Wide_Character'Val(16#2557#), 239),
      (Wide_Character'Val(16#255A#),Wide_Character'Val(16#255A#), 240),
      (Wide_Character'Val(16#255D#),Wide_Character'Val(16#255D#), 241),
      (Wide_Character'Val(16#2560#),Wide_Character'Val(16#2560#), 242),
      (Wide_Character'Val(16#2563#),Wide_Character'Val(16#2563#), 243),
      (Wide_Character'Val(16#2566#),Wide_Character'Val(16#2566#), 244),
      (Wide_Character'Val(16#2569#),Wide_Character'Val(16#2569#), 245),
      (Wide_Character'Val(16#256C#),Wide_Character'Val(16#256C#), 246),
      (Wide_Character'Val(16#2580#),Wide_Character'Val(16#2580#), 247),
      (Wide_Character'Val(16#2584#),Wide_Character'Val(16#2584#), 248),
      (Wide_Character'Val(16#2588#),Wide_Character'Val(16#2588#), 249),
      (Wide_Character'Val(16#2591#),Wide_Character'Val(16#2593#), 250),
      (Wide_Character'Val(16#25A0#),Wide_Character'Val(16#25A0#), 253),
...
begin
   Encoder_List (Encodings.CP_857) := Encode'Access;
   Decoder_List (Encodings.CP_857) := Decode'Access;
