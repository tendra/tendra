...
package body Encodings.Maps.ISO_8859_15 is

   Forward  : Forward_Map  (Character'Val(16#A4#) .. Character'Last) :=
   ...
   Ranges   : Maps.Wide_Ranges  (1 ..  12) :=
     ((Wide_Character'Val(   16#0#),Wide_Character'Val(  16#A3#), 1),
      (Wide_Character'Val(  16#A5#),Wide_Character'Val(  16#A5#), 165),
      (Wide_Character'Val(  16#A7#),Wide_Character'Val(  16#A7#), 166),
      (Wide_Character'Val(  16#A9#),Wide_Character'Val(  16#B3#), 167),
      (Wide_Character'Val(  16#B5#),Wide_Character'Val(  16#B7#), 178),
      (Wide_Character'Val(  16#B9#),Wide_Character'Val(  16#BB#), 181),
      (Wide_Character'Val(  16#BF#),Wide_Character'Val(  16#FF#), 184),
      (Wide_Character'Val( 16#152#),Wide_Character'Val( 16#153#), 249),
      (Wide_Character'Val( 16#160#),Wide_Character'Val( 16#161#), 251),
      (Wide_Character'Val( 16#178#),Wide_Character'Val( 16#178#), 253),
...
begin
   Encoder_List (Encodings.ISO_8859_15) := Encode'Access;
   Decoder_List (Encodings.ISO_8859_15) := Decode'Access;
