...
package body Encodings.Maps.ISO_8859_9 is

   Forward  : Forward_Map  (Character'Val(16#D0#) .. Character'Last) :=
   ...
   Ranges   : Maps.Wide_Ranges  (1 ..  8) :=
     ((Wide_Character'Val(   16#0#),Wide_Character'Val(  16#CF#), 1),
      (Wide_Character'Val(  16#D1#),Wide_Character'Val(  16#DC#), 209),
      (Wide_Character'Val(  16#DF#),Wide_Character'Val(  16#EF#), 221),
      (Wide_Character'Val(  16#F1#),Wide_Character'Val(  16#FC#), 238),
      (Wide_Character'Val(  16#FF#),Wide_Character'Val(  16#FF#), 250),
      (Wide_Character'Val( 16#11E#),Wide_Character'Val( 16#11F#), 251),
      (Wide_Character'Val( 16#130#),Wide_Character'Val( 16#131#), 253),
      (Wide_Character'Val( 16#15E#),Wide_Character'Val( 16#15F#), 255));
...
begin
   Encoder_List (Encodings.ISO_8859_9) := Encode'Access;
   Decoder_List (Encodings.ISO_8859_9) := Decode'Access;
