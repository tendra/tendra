...
package body Encodings.Maps.ISO_8859_8 is

   Forward  : Forward_Map  (Character'Val(16#AA#) .. Character'Last) :=
   ...
   Ranges   : Maps.Wide_Ranges  (1 ..  9) :=
     ((Wide_Character'Val(   16#0#),Wide_Character'Val(  16#A0#), 1),
      (Wide_Character'Val(  16#A2#),Wide_Character'Val(  16#A9#), 162),
      (Wide_Character'Val(  16#AB#),Wide_Character'Val(  16#B9#), 170),
      (Wide_Character'Val(  16#BB#),Wide_Character'Val(  16#BE#), 185),
      (Wide_Character'Val(  16#D7#),Wide_Character'Val(  16#D7#), 189),
      (Wide_Character'Val(  16#F7#),Wide_Character'Val(  16#F7#), 190),
      (Wide_Character'Val( 16#5D0#),Wide_Character'Val( 16#5EA#), 191),
      (Wide_Character'Val(16#200E#),Wide_Character'Val(16#200F#), 218),
      (Wide_Character'Val(16#2017#),Wide_Character'Val(16#2017#), 220));

   Backward : Maps.Backward_Map (1 ..  220) :=
     (Character'Val( 16#0#),
      Character'Val( 16#1#),
      Character'Val( 16#2#),
      Character'Val( 16#3#),
...
begin
   Encoder_List (Encodings.ISO_8859_8) := Encode'Access;
   Decoder_List (Encodings.ISO_8859_8) := Decode'Access;
