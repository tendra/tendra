...
package body Encodings.Maps.CP_1253 is
   ...
   Ranges   : Maps.Wide_Ranges  (1 ..  40) :=
     ((Wide_Character'Val(   16#0#),Wide_Character'Val(  16#7F#), 1),
      ...
      (Wide_Character'Val(  16#A3#),Wide_Character'Val(  16#A9#), 130),
      (Wide_Character'Val(  16#AB#),Wide_Character'Val(  16#AE#), 137),
      (Wide_Character'Val(  16#B0#),Wide_Character'Val(  16#B3#), 141),
      (Wide_Character'Val(  16#B5#),Wide_Character'Val(  16#B7#), 145),
      (Wide_Character'Val(  16#BB#),Wide_Character'Val(  16#BB#), 148),
      (Wide_Character'Val(  16#BD#),Wide_Character'Val(  16#BD#), 149),
      (Wide_Character'Val( 16#192#),Wide_Character'Val( 16#192#), 150),
      (Wide_Character'Val( 16#384#),Wide_Character'Val( 16#386#), 151),
      (Wide_Character'Val( 16#388#),Wide_Character'Val( 16#38A#), 154),
      (Wide_Character'Val( 16#38C#),Wide_Character'Val( 16#38C#), 157),
      (Wide_Character'Val( 16#38E#),Wide_Character'Val( 16#3A1#), 158),
      (Wide_Character'Val( 16#3A3#),Wide_Character'Val( 16#3CE#), 178),
      (Wide_Character'Val(16#2013#),Wide_Character'Val(16#2015#), 222),
      (Wide_Character'Val(16#2018#),Wide_Character'Val(16#201A#), 225),
      (Wide_Character'Val(16#201C#),Wide_Character'Val(16#201E#), 228),
      (Wide_Character'Val(16#2020#),Wide_Character'Val(16#2022#), 231),
      (Wide_Character'Val(16#2026#),Wide_Character'Val(16#2026#), 234),
      (Wide_Character'Val(16#2030#),Wide_Character'Val(16#2030#), 235),
      (Wide_Character'Val(16#2039#),Wide_Character'Val(16#203A#), 236),
      (Wide_Character'Val(16#20AC#),Wide_Character'Val(16#20AC#), 238),
      (Wide_Character'Val(16#2122#),Wide_Character'Val(16#2122#), 239),
...
begin
   Encoder_List (Encodings.CP_1253) := Encode'Access;
   Decoder_List (Encodings.CP_1253) := Decode'Access;
