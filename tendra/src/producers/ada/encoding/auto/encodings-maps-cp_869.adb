...
package body Encodings.Maps.CP_869 is
   ...
   Ranges   : Maps.Wide_Ranges  (1 ..  51) :=
     ((Wide_Character'Val(   16#0#),Wide_Character'Val(  16#7F#), 1),
      (Wide_Character'Val(  16#A0#),Wide_Character'Val(  16#A0#), 129),
      (Wide_Character'Val(  16#A3#),Wide_Character'Val(  16#A3#), 130),
      (Wide_Character'Val(  16#A6#),Wide_Character'Val(  16#A9#), 131),
      (Wide_Character'Val(  16#AB#),Wide_Character'Val(  16#AD#), 135),
      (Wide_Character'Val(  16#B0#),Wide_Character'Val(  16#B3#), 138),
      (Wide_Character'Val(  16#B7#),Wide_Character'Val(  16#B7#), 142),
      (Wide_Character'Val(  16#BB#),Wide_Character'Val(  16#BB#), 143),
      (Wide_Character'Val(  16#BD#),Wide_Character'Val(  16#BD#), 144),
      (Wide_Character'Val( 16#384#),Wide_Character'Val( 16#386#), 145),
      (Wide_Character'Val( 16#388#),Wide_Character'Val( 16#38A#), 148),
      (Wide_Character'Val( 16#38C#),Wide_Character'Val( 16#38C#), 151),
      (Wide_Character'Val( 16#38E#),Wide_Character'Val( 16#3A1#), 152),
      (Wide_Character'Val( 16#3A3#),Wide_Character'Val( 16#3CE#), 172),
      (Wide_Character'Val(16#2015#),Wide_Character'Val(16#2015#), 216),
      (Wide_Character'Val(16#2018#),Wide_Character'Val(16#2019#), 217),
      (Wide_Character'Val(16#2500#),Wide_Character'Val(16#2500#), 219),
      (Wide_Character'Val(16#2502#),Wide_Character'Val(16#2502#), 220),
      (Wide_Character'Val(16#250C#),Wide_Character'Val(16#250C#), 221),
      (Wide_Character'Val(16#2510#),Wide_Character'Val(16#2510#), 222),
      (Wide_Character'Val(16#2514#),Wide_Character'Val(16#2514#), 223),
      (Wide_Character'Val(16#2518#),Wide_Character'Val(16#2518#), 224),
      (Wide_Character'Val(16#251C#),Wide_Character'Val(16#251C#), 225),
      (Wide_Character'Val(16#2524#),Wide_Character'Val(16#2524#), 226),
      (Wide_Character'Val(16#252C#),Wide_Character'Val(16#252C#), 227),
      (Wide_Character'Val(16#2534#),Wide_Character'Val(16#2534#), 228),
      (Wide_Character'Val(16#253C#),Wide_Character'Val(16#253C#), 229),
      (Wide_Character'Val(16#2550#),Wide_Character'Val(16#2551#), 230),
      (Wide_Character'Val(16#2554#),Wide_Character'Val(16#2554#), 232),
      (Wide_Character'Val(16#2557#),Wide_Character'Val(16#2557#), 233),
      (Wide_Character'Val(16#255A#),Wide_Character'Val(16#255A#), 234),
      (Wide_Character'Val(16#255D#),Wide_Character'Val(16#255D#), 235),
      (Wide_Character'Val(16#2560#),Wide_Character'Val(16#2560#), 236),
      (Wide_Character'Val(16#2563#),Wide_Character'Val(16#2563#), 237),
      (Wide_Character'Val(16#2566#),Wide_Character'Val(16#2566#), 238),
      (Wide_Character'Val(16#2569#),Wide_Character'Val(16#2569#), 239),
      (Wide_Character'Val(16#256C#),Wide_Character'Val(16#256C#), 240),
      (Wide_Character'Val(16#2580#),Wide_Character'Val(16#2580#), 241),
      (Wide_Character'Val(16#2584#),Wide_Character'Val(16#2584#), 242),
      (Wide_Character'Val(16#2588#),Wide_Character'Val(16#2588#), 243),
      (Wide_Character'Val(16#2591#),Wide_Character'Val(16#2593#), 244),
      (Wide_Character'Val(16#25A0#),Wide_Character'Val(16#25A0#), 247),
...
begin
   Encoder_List (Encodings.CP_869) := Encode'Access;
   Decoder_List (Encodings.CP_869) := Decode'Access;
