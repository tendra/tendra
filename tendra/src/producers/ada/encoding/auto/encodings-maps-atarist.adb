...
package body Encodings.Maps.ATARIST is
   ...
   Forward  : Forward_Map  (Character'Val(16#80#) .. Character'Last) :=
     (Wide_Character'Val(  16#C7#),
      ...
      Wide_Character'Val( 16#133#),
      Wide_Character'Val( 16#132#),
      ...
      Wide_Character'Val(16#222E#),
      Wide_Character'Val( 16#3C6#),
      Wide_Character'Val(16#2208#),
   ...
   Ranges   : Maps.Wide_Ranges  (1 ..  44) :=
     ((Wide_Character'Val(   16#0#),Wide_Character'Val(  16#7F#), 1),
      (Wide_Character'Val(  16#A1#),Wide_Character'Val(  16#A3#), 129),
      (Wide_Character'Val(  16#A5#),Wide_Character'Val(  16#A5#), 132),
      (Wide_Character'Val(  16#A7#),Wide_Character'Val(  16#AC#), 133),
      (Wide_Character'Val(  16#AE#),Wide_Character'Val(  16#B7#), 139),
      (Wide_Character'Val(  16#BA#),Wide_Character'Val(  16#BD#), 149),
      (Wide_Character'Val(  16#BF#),Wide_Character'Val(  16#C0#), 153),
      (Wide_Character'Val(  16#C3#),Wide_Character'Val(  16#C7#), 155),
      (Wide_Character'Val(  16#C9#),Wide_Character'Val(  16#C9#), 160),
      (Wide_Character'Val(  16#D1#),Wide_Character'Val(  16#D1#), 161),
      (Wide_Character'Val(  16#D5#),Wide_Character'Val(  16#D6#), 162),
      (Wide_Character'Val(  16#D8#),Wide_Character'Val(  16#D8#), 164),
      (Wide_Character'Val(  16#DC#),Wide_Character'Val(  16#DC#), 165),
      (Wide_Character'Val(  16#DF#),Wide_Character'Val(  16#EF#), 166),
      (Wide_Character'Val(  16#F1#),Wide_Character'Val(  16#FC#), 183),
      (Wide_Character'Val(  16#FF#),Wide_Character'Val(  16#FF#), 195),
      (Wide_Character'Val( 16#132#),Wide_Character'Val( 16#133#), 196),
      (Wide_Character'Val( 16#152#),Wide_Character'Val( 16#153#), 198),
      (Wide_Character'Val( 16#192#),Wide_Character'Val( 16#192#), 200),
      (Wide_Character'Val( 16#393#),Wide_Character'Val( 16#393#), 201),
      (Wide_Character'Val( 16#398#),Wide_Character'Val( 16#398#), 202),
      (Wide_Character'Val( 16#3A3#),Wide_Character'Val( 16#3A3#), 203),
      (Wide_Character'Val( 16#3A6#),Wide_Character'Val( 16#3A6#), 204),
      (Wide_Character'Val( 16#3A9#),Wide_Character'Val( 16#3A9#), 205),
      (Wide_Character'Val( 16#3B1#),Wide_Character'Val( 16#3B2#), 206),
      (Wide_Character'Val( 16#3B4#),Wide_Character'Val( 16#3B4#), 208),
      (Wide_Character'Val( 16#3C0#),Wide_Character'Val( 16#3C0#), 209),
      (Wide_Character'Val( 16#3C3#),Wide_Character'Val( 16#3C4#), 210),
      (Wide_Character'Val( 16#3C6#),Wide_Character'Val( 16#3C6#), 212),
      (Wide_Character'Val( 16#5D0#),Wide_Character'Val( 16#5EA#), 213),
      (Wide_Character'Val(16#2020#),Wide_Character'Val(16#2020#), 240),
      (Wide_Character'Val(16#207F#),Wide_Character'Val(16#207F#), 241),
      (Wide_Character'Val(16#2122#),Wide_Character'Val(16#2122#), 242),
      (Wide_Character'Val(16#2208#),Wide_Character'Val(16#2208#), 243),
      (Wide_Character'Val(16#2219#),Wide_Character'Val(16#221A#), 244),
      (Wide_Character'Val(16#221E#),Wide_Character'Val(16#221E#), 246),
      (Wide_Character'Val(16#2227#),Wide_Character'Val(16#2227#), 247),
      (Wide_Character'Val(16#2229#),Wide_Character'Val(16#2229#), 248),
      (Wide_Character'Val(16#222E#),Wide_Character'Val(16#222E#), 249),
      (Wide_Character'Val(16#2248#),Wide_Character'Val(16#2248#), 250),
      (Wide_Character'Val(16#2261#),Wide_Character'Val(16#2261#), 251),
      (Wide_Character'Val(16#2264#),Wide_Character'Val(16#2265#), 252),
      (Wide_Character'Val(16#2310#),Wide_Character'Val(16#2310#), 254),
      (Wide_Character'Val(16#2320#),Wide_Character'Val(16#2321#), 255));
...
begin
   Encoder_List (Encodings.ATARIST) := Encode'Access;
   Decoder_List (Encodings.ATARIST) := Decode'Access;
