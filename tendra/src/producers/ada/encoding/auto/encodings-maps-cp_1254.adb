...
package body Encodings.Maps.CP_1254 is
   ...
   Ranges   : Maps.Wide_Ranges  (1 ..  30) :=
     ((Wide_Character'Val(   16#0#),Wide_Character'Val(  16#7F#), 1),
      ...
      (Wide_Character'Val( 16#152#),Wide_Character'Val( 16#153#), 223),
      (Wide_Character'Val( 16#15E#),Wide_Character'Val( 16#161#), 225),
      (Wide_Character'Val( 16#178#),Wide_Character'Val( 16#178#), 229),
      (Wide_Character'Val( 16#192#),Wide_Character'Val( 16#192#), 230),
      (Wide_Character'Val( 16#2C6#),Wide_Character'Val( 16#2C6#), 231),
      (Wide_Character'Val( 16#2DC#),Wide_Character'Val( 16#2DC#), 232),
      (Wide_Character'Val(16#2013#),Wide_Character'Val(16#2014#), 233),
      (Wide_Character'Val(16#2018#),Wide_Character'Val(16#201A#), 235),
      (Wide_Character'Val(16#201C#),Wide_Character'Val(16#201E#), 238),
      (Wide_Character'Val(16#2020#),Wide_Character'Val(16#2022#), 241),
      (Wide_Character'Val(16#2026#),Wide_Character'Val(16#2026#), 244),
      (Wide_Character'Val(16#2030#),Wide_Character'Val(16#2030#), 245),
      (Wide_Character'Val(16#2039#),Wide_Character'Val(16#203A#), 246),
      (Wide_Character'Val(16#20AC#),Wide_Character'Val(16#20AC#), 248),
      (Wide_Character'Val(16#2122#),Wide_Character'Val(16#2122#), 249),
...
begin
   Encoder_List (Encodings.CP_1254) := Encode'Access;
   Decoder_List (Encodings.CP_1254) := Decode'Access;
