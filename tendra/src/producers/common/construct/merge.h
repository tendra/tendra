...
extern int compatible_class PROTO_S ( ( CLASS_TYPE, CLASS_TYPE ) ) ;
extern void merge_namespaces PROTO_S ( ( NAMESPACE, NAMESPACE ) ) ;
extern int merge_type PROTO_S ( ( IDENTIFIER, IDENTIFIER ) ) ;
