...
#if TDF_OUTPUT
extern BITSTREAM *enc_stmt PROTO_S ( ( BITSTREAM *, EXP ) ) ;
extern BITSTREAM *enc_compound_stmt PROTO_S ( ( BITSTREAM *, EXP ) ) ;
extern BITSTREAM *enc_stmt_exp PROTO_S ( ( BITSTREAM *, EXP, TYPE, int ) ) ;
extern unsigned stmt_length PROTO_S ( ( EXP ) ) ;
