...
extern void begin_spec PROTO_S ( ( void ) ) ;
extern void end_spec PROTO_S ( ( void ) ) ;
extern BITSTREAM *save_id PROTO_S ( ( BITSTREAM *, IDENTIFIER, NAMESPACE ) ) ;
extern BITSTREAM *save_end PROTO_S ( ( BITSTREAM *, NAMESPACE ) ) ;
