...
extern MapTableP		map_table_create
	PROTO_S ((void));
extern MapEntryP		map_table_add
	PROTO_S ((MapTableP, NStringP, unsigned));
extern MapEntryP		map_table_get
	PROTO_S ((MapTableP, NStringP));
extern void			map_table_iter
	PROTO_S ((MapTableP, void (*) (MapEntryP, GenericP), GenericP));
