...
extern void clear_reg PROTO_S ((int i));
extern ans iskept PROTO_S ((exp e));
extern void keepexp PROTO_S ((exp e, ans loc));
extern void clear_dep_reg PROTO_S ((exp lhs));
extern void keepcont PROTO_S ((exp e, int reg));
extern void keepreg PROTO_S ((exp e, int reg));
