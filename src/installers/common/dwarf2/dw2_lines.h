...
extern void do_statprog_prologue PROTO_S ((long l_start, long l_end));
extern void dw2_source_mark PROTO_S ((short_sourcepos pos, int is_stmt));
extern void dw2_start_basic_block PROTO_S ((void));
extern void close_statprog PROTO_S ((long l_end));
