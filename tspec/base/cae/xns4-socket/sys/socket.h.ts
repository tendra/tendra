...
+SUBSET "sock_generic" := {
	...
	+USE "cae/xsh4v2-base", "sys/types.h.ts" ;
	+USE "cae/xsh4v2-unix", "sys/uio.h.ts" ;
	...
	+FUNC int accept ( int, struct sockaddr *, ~socklen_t * ) ;
	+FUNC int bind ( int, const struct sockaddr *, ~socklen_t ) ;
	+FUNC int connect ( int, const struct sockaddr *, ~socklen_t ) ;
	+FUNC int getpeername ( int, const struct sockaddr *, ~socklen_t * ) ;
	+FUNC int getsockname ( int, const struct sockaddr *, ~socklen_t * ) ;
	+FUNC int getsockopt ( int, int, int, void *, ~socklen_t * ) ;
	...
	+FUNC int setsockopt ( int, int, int, const void *, ~socklen_t ) ;
