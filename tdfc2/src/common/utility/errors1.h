...
#define OPT_va_macro 148
#define OPT_variable 149
#define OPT_weak 150
#endif
...
#define ERR_cpp_replace_arg_number2( A, B, C, D )\
	ERR_GEN ( 864, chk_6 ( A ), chk_M ( B ), chk_N ( C ), chk_M ( D ) )

#define ERR_cpp_replace_va_args_bad( A )\
	ERR_GEN ( 865, chk_6 ( A ) )
...
#define ERR_limits_max( A, B, C )\
	ERR_GEN ( 896, chk_J ( A ), chk_L ( B ), chk_L ( C ) )

#define ERR_limits_min( A, B, C )\
	ERR_GEN ( 897, chk_J ( A ), chk_L ( B ), chk_L ( C ) )
...
#define ERR_token_redef( A, B )\
	ERR_GEN ( 933, chk_7 ( A ), chk_D ( B ) )

#define ERR_token_redef_ok( A, B )\
	ERR_GEN ( 934, chk_7 ( A ), chk_D ( B ) )
...
#define ERR_token_arg_type( A, B, C )\
	ERR_GEN ( 960, chk_8 ( A ), chk_7 ( B ), chk_G ( C ) )

#define ERR_token_recursive( A )\
	ERR_GEN ( 961, chk_7 ( A ) )

#define ERR_token_arg_undef( A, B )\
	ERR_GEN ( 962, chk_7 ( A ), chk_7 ( B ) )

#define ERR_token_conv( A, B, C )\
	ERR_GEN ( 963, chk_7 ( A ), chk_G ( B ), chk_G ( C ) )
