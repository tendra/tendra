...
LISTENVS ?= ${MAKE} listenvs
LISTENV_BASE ?= ${BASE_DIR}
...
ENVCAT= Envcat() {                                                  \
        ...
        for env in $${*}; do                                        \
            cat $${env}                                             \
            | sed 's,^/\* \$$Id,/* '$${env\#${LISTENV_BASE}/machines/}': $$Id,g'; \
            echo;                                                   \
        done                                                        \
    }; Envcat
...
_ENVCOMMON_${dir} != cd ${LISTENV_BASE}/${dir} && ${LISTENVS}
...
.for env in ${ENVFILE}
.for dir in ${ENVCOMMON}
.  if exists(${LISTENV_BASE}/${dir}/${env})
${OBJ_DIR}/env/${env}: ${LISTENV_BASE}/${dir}/${env}
.  endif
. endfor
.endfor
