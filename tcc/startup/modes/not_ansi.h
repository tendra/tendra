...
/*
 * STARTUP FILE FOR NON-ANSI FEATURES
 *
 * not_ansi allows for variety of non-ANSI and pre-ANSI features through.
 * It is primarily concerned with syntactic, as opposed to portability,
 * features.
 */
