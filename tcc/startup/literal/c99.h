...
#pragma integer literal decimal              long      __l | __lu | __ll | __llu
#pragma integer literal octal                long      __l | __lu | __ll | __llu
#pragma integer literal hexadecimal          long      __l | __lu | __ll | __llu

#pragma integer literal decimal                        __i | __l | __lu | __ll | __llu
#pragma integer literal octal                          __i | __u | __l | __lu | __ll | __llu
#pragma integer literal hexadecimal                    __i | __u | __l | __lu | __ll | __llu
